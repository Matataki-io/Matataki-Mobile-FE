<template>
  <div class="container">
    <BaseHeader :pageinfo="{ title: '邮箱绑定' }" :has-bottom-border-line="true" customize-header-bc="#fff" />
      ...
      <div v-if="setp === 0" class="step">
        ...
        <el-form ref="emailAddress" :rules="rules" :model="emailAddress" @submit.native.prevent>
          <el-form-item label="" prop="email">
            <el-input v-model="emailAddress.email" type="text" placeholder="请输入邮箱账号" @change="emailAddressOnSubmit('emailAddress')" />
          </el-form-item>
