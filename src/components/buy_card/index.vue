  ...
  <div class="buy-block">
    ...
    <div :class="type === 'article' && 'no-padding'" class="container">
      ...
      <div class="info">
        ...
        <p v-if="type === 'article'" class="author">{{ buy && (buy.nickname || buy.author) }}</p>
        <p class="money">
  ...
  computed: {
    buyAmount() {
      ...
      if (this.type === 'article')
        return precision(this.buy.amount, this.buy.platform, this.buy.decimals)
      // 文章卡片
      else if (this.type === 'other') return precision(this.buy.amount, this.buy.symbol)
      // 其他卡片
      else return precision(this.buy.amount, this.buy.symbol) // 默认文章卡片
    },
    amount() {
      if (this.type === 'article') return this.buy && this.buy.platform.toUpperCase()
      // 文章卡片
      else if (this.type === 'other') return this.buy && this.buy.symbol.toUpperCase()
      // 其他卡片
